...
create utilities and extensions.
...
Now that we have defined the core interfaces, we can start building on top of them. The next part of this series will
focus on building utilities and extensions for the common operations.
